            ...
            if (AGV_Info != null && AGV_Info.Rows.Count > 0)
            {
                ...
                for (int i = 0; i < GetCount; i++)
                {
                    if (i < AGV_Info.Rows.Count)
                    {
                        ...
                        dg_CarInfo.Rows[i].Cells[6].Value = Function.retErr(AGV_Info.Rows[i][8].ToString().Trim());
                        ...
                        dg_CarInfo.Rows[i].Cells[7].Value = GetVoltageString(AGV_Info.Rows[i][9].ToString().Trim());

                        dg_CarInfo.Rows[i].Cells[8].Value = AGV_Info.Rows[i][10].ToString().Trim() == "1" ? "行驶中>>>" : "停止中";
                        ...
                        {
                            if (dg_CarInfo.Rows[i].Cells[7].Style.BackColor != Color.Yellow)
                                dg_CarInfo.Rows[i].Cells[7].Style.BackColor = Color.Yellow;
                        }
